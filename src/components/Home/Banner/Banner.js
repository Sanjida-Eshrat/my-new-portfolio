        ...
        style={{
            ...
            <Container fluid>
                <div className="text-center container top-banner" style={{paddingTop:'195px',paddingBlockEnd:'180px'}}>
                    <h1 className="pt-4 text-2">Hi! I'm <span className="text-info">Sanjida Eshrat</span></h1>
                    ...
                    <a href="https://drive.google.com/file/d/1ng9SJ6xbfLH8BGwL6hZ3OqkqgS8LBGTt/view?usp=sharing" target="_blank">
                      <Button className='text-white mt-4 mb-3' variant="outline-info"><i class="fas fa-download"></i> Download Resume</Button>{' '}
                    </a>
